...
/*enum Ascale {
  AFS_2G = 0, //means the resolution of sensor is +-2 gravity/sec(dps)
  AFS_4G,
  AFS_8G,
  AFS_16G
};
...
enum Gscale {
	GFS_250DPS = 0,//means the resolution of sensor is +-250 degree/sec(dps)
	GFS_500DPS,
	GFS_1000DPS,
	GFS_2000DPS
};
